...
У нас есть три цифры, описывающие версию проекта. Например, 1.2.1.
   ...
   - Первая цифра говорит о МАЖОРНОЙ версии. МАЖОРНУЮ версию повышаем когда внесенные изменения не совместимы с придыдущей версией продукта.
   - Вторая — о МИНОРНОЙ версии. Повышаем когда добавили какую то новую функциональность.
   - Третья говорит о ПАТЧ версии. Повышаем при сделанном исправлении.
